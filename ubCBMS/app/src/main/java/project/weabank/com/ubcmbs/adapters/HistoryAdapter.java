...
public class HistoryAdapter extends RecyclerView
    ...
    public HistoryAdapter(ArrayList<HistoryModel> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void addItem(HistoryModel dataObj, int index) {
